...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['notification_id'])){
    mark_notification_read($conn, (int) $_POST['notification_id'], 'Management', $management_id);
...
$notifications = get_user_notifications($conn, 'Management', $management_id, 5);
...
.notification-item button{padding:8px 12px;border:0;border-radius:6px;background:#15803d;color:#fff;cursor:pointer;}
